...
export default function CategoryModal({ category, onClose }: { category: string, onClose: () => void }) {
    return (
      <Backdrop show={true} center={true}>
        <Container 
            variant="div" 
            className={"p-6 md:py-6 md:px-10 bg-white h-auto max-h-[90vh] md:max-h-none w-[95vw] md:w-full md:min-w-xl rounded-md flex flex-col overflow-y-auto md:overflow-visible shadow-2xl"}
        >
            <Container 
                variant="div" 
