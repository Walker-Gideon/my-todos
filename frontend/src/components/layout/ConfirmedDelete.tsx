...
export default function ConfirmDelete({
  ...
  return (
    <Backdrop show={show} center={true}>
      ...
      >
        <Container variant="div" className={"w-full flex justify-end"}>
          <Button
            variant="text"
        ...
        <Container variant="div" className={"space-y-2 flex-1 min-w-0"}>
          <Headings
            variant="h1"
          ...
          >
            ...
            <Span
              className={"pl-1 italic truncate min-w-0 flex-1"}
              title={resourceName}
            >
              {resourceName}
            </Span>
          ...
          <Paragraph variant="small" className={"text-gray-500 break-words"}>
            ...
            <Span
              className={"px-1 italic break-all text-base font-semibold"}
              title={resourceName}
            >
              {resourceName}
            </Span>
          ...
          <Container variant="div" className={"flex gap-2 justify-end"}>
            <Button
              variant="outline"
